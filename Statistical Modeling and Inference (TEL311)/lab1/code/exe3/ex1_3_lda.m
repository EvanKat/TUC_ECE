...
%
fprintf('Calculate FDA unit form Vector for 2D examples\n\n');
...
fprintf('Displaying LDA on example dataset.\n\n');
hold on;
...
fprintf('Loading fisheriris dataset for LDA.\n');
...
fprintf('Visualizing dataset before and after LDA (2D).\n\n');
...
hold on
legend('label 0','label 1','label 2')

fprintf('Program paused. Press enter to continue.\n');
fprintf('----------------------------------------\n\n');

% Apply LDA
NewDim = 1; %The new feature dimension after applying LDA
...
figure(4)
meas_reduced = meas_reduced';

% Get the data for each class
I1 = meas_reduced(iris_labels==0, :);	%Samples of Class 0
I2 = meas_reduced(iris_labels==1, :);	%Samples of Class 1
I3 = meas_reduced(iris_labels==2, :);	%Samples of Class 2
% displayData(meas_reduced);
